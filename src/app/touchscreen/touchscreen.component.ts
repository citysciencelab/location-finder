...
export class TouchscreenComponent implements OnInit {
  ...
  constructor(private config: ConfigurationService, private localStorageService: LocalStorageService, private tuioService: TuioService,
